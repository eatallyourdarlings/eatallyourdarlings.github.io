...
---------------
notes from Olive:
one dot in the grid is 15px
when exporting a vector, it's the size of the <canvas> that determines the <svg> width/height
this means that if you zoom in, it'll export just the zoomed part of the vector.
---------------
